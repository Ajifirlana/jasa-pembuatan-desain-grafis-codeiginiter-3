    <section class="site-section">
      ...
      <?php }else{?>
        ...
        <div class="row">
          <form class="col-md-8 mb-5" id="ini_formnya" method="post">
            <div class="p-4 bg-white">
              <h2 class="h4 text-black mb-3">Form Pembelian Custom</h2>
              <div class="row form-group">
                <div class="col-md-12">
                  <div id="ubah_sini"></div>
                  <label class="text-black" for="email">Jumlah</label> 
                  <input type="text" name="jumlah" class="form-control" minlength="1" maxlength="3" required="">
                 </div>
              </div> 
                  ...
                  <input type="Text" class="form-control" name="total_harga" value="" >
                  ...
                  <div class="row form-group">
                    <div class="col-md-12">
                    <label class="text-black" for="email">Ongkir</label> 
                  ...
                  <div class="row form-group">
                    <div class="col-md-12">
                    <label class="text-black" for="email">Total Akhir ( Ongkir + Harga)</label> 
                  <input type="Text" class="form-control" name="total_akhir" value="" >
                  ...
                  <div class="row form-group">
                    <div class="col-md-12">
                    <label class="text-black" for="email">Pengirim</label> 
                  <input type="Text" class="form-control" id="pengirim" value="" >
                  ...
                  <div class="row form-group">
                    <div class="col-md-12">
                    <label class="text-black" for="email">Penerima</label> 
                  <input type="Text" class="form-control" id="penerima" value="" >
                  ...
                  <div class="row form-group">
                    <div class="col-md-12">
                    <label class="text-black" for="email">Detail Alamat</label> 
                  <input type="Text" class="form-control" id="detail_alamat" value="" >
                  ...
                  <div class="row form-group">
                    <div class="col-md-12">
                    <label class="text-black" for="email">Untuk Tanggal</label> 
                  <input type="date" class="form-control" id="untuk_tanggal" value="" >
                  ...
                  <div class="row form-group">
                    <div class="col-md-12">
                    <label class="text-black" for="email">Catatan</label> 
                  <input type="Text" class="form-control" id="catatan" value="" >
            ...
            <div class="p-4 bg-white">
             ...
             <div class="row form-group">
                <div class="col-md-12">
                  <center>
                    <!-- <input type="submit" value="Pesan" class="btn btn-primary btn-md text-white" name="pesan"> -->
                    <button type="button" onclick="proses_custom()" class="btn btn-primary btn-md text-white">Submit</button>
                  </center>
                </div>
              </div>
            </div>
